...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            db::commands::db_get_calendar_events_in_range_for_calendars,
            db::commands::db_get_all_calendars,
            db::commands::db_get_calendars_for_account,
            db::commands::db_get_calendar_by_id,
            db::commands::db_create_calendar,
            db::commands::db_update_calendar,
            db::commands::db_delete_calendar,
            db::commands::db_set_calendar_visible,
            db::commands::db_set_primary_calendar,
            ...
            db::commands::db_delete_crypto_key,
            db::commands::db_set_default_signing_key,
            ...
            // Plan 4b Task 2 — S/MIME generate / import / export lifecycle.
