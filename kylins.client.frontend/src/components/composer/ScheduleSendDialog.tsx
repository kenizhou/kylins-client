        ...
        <Dialog aria-label="Schedule send" className="outline-none">
          ...
          <div className="space-y-1">
            {presets.map((p) => (
              <Button
                ...
                className="flex min-h-11 w-full items-center justify-between rounded-lg px-2 py-1.5 text-left text-sm text-foreground transition-colors hover:bg-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
                <span>{p.label}</span>
          ...
          <div className="mt-3 border-t border-border pt-3">
            ...
            <input
              ...
              className="h-11 w-full rounded-lg border border-border bg-background px-2 text-sm text-foreground outline-none focus:border-primary"
            />
          </div>
