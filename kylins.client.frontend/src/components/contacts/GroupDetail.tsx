              ...
              {isEditing ? (
                <>
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 min-h-11 min-w-11 text-xs font-medium rounded-md border border-[var(--border-subtle)] bg-surface-elevated text-[var(--foreground)] hover:bg-[var(--primary-subtle)] transition-colors focus-visible:ring-2 focus-visible:ring-[var(--ring)]"
                  >
                    <CloseIcon size={13} />
                    Cancel
                  </button>
                ...
                <>
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 min-h-11 min-w-11 text-xs font-medium rounded-md border border-[var(--border-subtle)] bg-surface-elevated text-[var(--destructive)] hover:bg-[var(--primary-subtle)] transition-colors focus-visible:ring-2 focus-visible:ring-[var(--ring)] disabled:opacity-50"
                  >
                    <TrashIcon size={13} />
                    Delete
                  </button>
                  <button
                    ...
                    disabled={isLoading}
                    className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 min-h-11 min-w-11 text-xs font-medium rounded-md border border-[var(--border-subtle)] bg-surface-elevated text-[var(--foreground)] hover:bg-[var(--primary-subtle)] transition-colors focus-visible:ring-2 focus-visible:ring-[var(--ring)] disabled:opacity-50"
                  >
                    <PlusIcon size={13} />
                    Add member
                  </button>
      ...
      <Modal
        ...
        footer={
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-4 py-2 min-h-11 min-w-11 text-sm font-medium rounded-md border border-[var(--border-subtle)] bg-surface-elevated text-[var(--foreground)] hover:bg-[var(--primary-subtle)] transition-colors focus-visible:ring-2 focus-visible:ring-[var(--ring)]"
          >
            Cancel
          </button>
        }
              ...
              {nonMembers.map((contact) => (
                <li key={contact.id}>
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full flex items-center gap-3 rounded-lg border border-[var(--border-subtle)] bg-surface-elevated px-3 py-2 min-h-11 text-left hover:bg-[var(--primary-subtle)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] disabled:opacity-50"
                  >
