      ...
      <PreferencesTabColumns
        left={
          <>
            ...
            <PreferencesSectionCard title="Storage" icon={PreferencesLocalDataIcon}>
              <ButtonRow
                label="Cache size"
          ...
          <>
            ...
            <PreferencesSectionCard title="Composing" icon={PreferencesComposingIcon}>
              ...
              <div className="ml-7 p-3 rounded-lg bg-[var(--highlight)] border border-[var(--border)] text-sm text-[var(--foreground)]">
                <span className="font-semibold text-[var(--foreground)]">NOTE:</span> Many features
                are unavailable in plain-text mode. To create a single plain-text draft, hold Alt or
                Option while clicking Compose or Reply.
              </div>
              <CheckboxRow
            ...
            <PreferencesSectionCard
              ...
              icon={PreferencesPrivacySecurityIcon}
            >
              <CheckboxRow
              ...
              <div className="text-sm text-[var(--foreground)] space-y-2">
                <p>
                  <span className="font-medium">Encryption at rest:</span> OAuth tokens, refresh
                  tokens, and IMAP passwords are encrypted with AES-256-GCM before being stored in
                  SQLite.
                </p>
            ...
            <PreferencesSectionCard title="Development data" icon={PreferencesLocalDataIcon}>
              <p className="text-sm text-[var(--muted-text)] mb-3">
                Generate realistic dummy accounts, contacts, emails, attachments, calendar events,
                signatures, templates, and tasks for local testing.
              </p>
              ...
              {seedStatus && <p className="mt-3 text-xs text-[var(--muted-text)]">{seedStatus}</p>}
            </PreferencesSectionCard>
          </>
        }
      />
