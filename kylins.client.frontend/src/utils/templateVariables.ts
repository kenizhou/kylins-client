 ...
 */
export async function interpolateVariables(html: string, ctx: VariableContext): Promise<string> {
 ...
 */
export function interpolateVariablesSync(html: string, ctx: VariableContext): string {
  if (!html.includes('{{')) return html;
